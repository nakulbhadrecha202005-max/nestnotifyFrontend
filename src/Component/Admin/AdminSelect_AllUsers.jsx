  ...
  const deleteUser = async () => {
    ...
    try {
      ...
      if (deletedata.ok) {
        ...
        alert(data.message || "Deletion refused by validation server.");
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-[#161613] text-[#DDFFF7] antialiased p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <div className="mt-3 space-y-0.5 text-xs text-[#898952]">
              ...
              <p>
                <span className="font-semibold text-white/70">Endpoint:</span>{" "}
                {userEmail}
              </p>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        {/* DATA ENTRIES COL */}
        <div className={`space-y-3 lg:col-span-${showFormPanel ? "2" : "3"}`}>
                  ...
                  <div className="space-y-1.5 flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 pt-1 text-xs">
                      ...
                      <span className="text-[#898952] text-[11px]">
                        ...
                        <span
                          className={
                            user?.agreeTerms ? "text-[#93E1D8]" : "text-red-400"
                          }
                        >
